...
def ask_chatgpt(myPrompt, myContent, model="gpt-4o-2024-08-06",max_tokens=8192,temperature=0.2):
    response_text=ask_chatgpt_online(myPrompt,myContent,model,max_tokens,temperature)
    return  response_text

def ask_chatgpt_online(myPrompt, myContent, model="gpt-4o-2024-08-06",max_tokens=8192,temperature=0.2):
