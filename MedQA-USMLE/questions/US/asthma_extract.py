...
output_csv = 'asthma_questions_mc.csv'
...
try:
    with open(file_path, 'r', encoding='utf-8') as f:
        for line in f:
            ...
            if 'asthma' in question['question'].lower():
...
with open(output_csv, 'w', newline='', encoding='utf-8') as csvfile:
    ...
    for question in asthma_questions:
        ...
        writer.writerow({
            # concatenate question and options
            'question': question['question'] + ' ' + '; '.join(options.values()),
            'answer_detail': answer,
            'answer': answer_label,
        })

print(f"Asthma-related questions saved to {output_csv}")
